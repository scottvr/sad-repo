"""Run baselines: independent adapters, naive LoRA stacking, coefficient
addition. Saves artifacts/baselines.json.

Usage: python scripts/run_baselines.py [--model distilgpt2] [--steps N]
"""
import argparse
...
def main():
    ...
    results = run_full_suite(
        cfg, methods=("independent", "naive_stack", "coeff_add"),
